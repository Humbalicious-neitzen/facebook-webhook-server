...
async function askBrain({ text, surface, history = [] }) {
  ...
  try {
    ...
    const availableTools = { getWeatherForecast, findNearbyPlaces };
    const toolMessages = [];
...
module.exports = { askBrain, userContent, getWeatherForecast, findNearbyPlaces };
